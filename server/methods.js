  ...
  ;
    ...
    s3.deleteObject(params, Meteor.bindEnvironment(function (error, data){
      if (!error) {
        ...
        // now that a pattern preview is generated automatically, an image is never used as the preview. This code caused an error if there were no other images for this pattern, so for now it is just disabled.
