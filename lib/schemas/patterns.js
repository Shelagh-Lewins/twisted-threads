...
if (Meteor.isServer) {
  ...
  // My Patterns (patterns by owner)
  Patterns.rawCollection().createIndex( {created_by: 1, private: 1} );

  // New Patterns (patterns by creation date, newest first)
  Patterns.rawCollection().createIndex( {created_at: -1, private: 1} );

  // All Patterns (patterns by name)
  Patterns.rawCollection().createIndex( {name: 1, private: 1} );
}
